...
export default function FooterComp() {
    ...
    return(
        ...
        <div className={"h-10 justify-center w-full flex my-5"}>

            <div className={"block"}> <div className={"flex flex-row gap-2 justify-center"}> <Link href="https://www.linkedin.com/in/brendon-kruger-a5a846232/">
                ...
                <p>©{currentYear} Brendon's Portfolio </p></div>
